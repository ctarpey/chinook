...
### Each data type has a different population map because they all contain different individuals and populations
### and each of the population groups within a data type has a different map because they also contain different individuals and populations. 
